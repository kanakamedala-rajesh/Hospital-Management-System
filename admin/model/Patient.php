...
class Patient
{
  ...
  public function validateData()
  {
    ...
    if ($this->_nif == "" || !filter_var($this->_nif, FILTER_VALIDATE_EMAIL) )
    {
      $valid = false;
      $this->_surname2Error = _("Email must be in valid format");
    }
    ...
    if ($this->_birthDate != "")
    {
      ...
      {
        $valid = false;
        $this->_birthDateError = _("This date is not correct.");
      }
    }
