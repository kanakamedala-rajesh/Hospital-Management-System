<?php
  ...
  echo HTML::start('meta', array('name' => 'author', 'content' => ''), true);
  echo HTML::start('meta', array('name' => 'copyright', 'content' => ' '), true);
  echo HTML::start('meta', array('name' => 'keywords', 'content' => ''), true);
  echo HTML::start('meta', array('name' => 'description', 'content' => 'medical records'), true);
?>
